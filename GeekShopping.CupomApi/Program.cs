...
using GeekShopping.CupomApi.Config;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "GeekShopping.CupomApi", Version = "v1" });
    c.EnableAnnotations();
...
builder.Services.AddDbContext<MySqlCupmApiContext>(options =>
